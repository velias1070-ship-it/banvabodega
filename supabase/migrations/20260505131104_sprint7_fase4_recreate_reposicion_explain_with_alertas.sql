-- Sprint 7 Fase 4 — Recrear v_reposicion_explain con alertas + alertas_count
-- batch:20260505-sprint-7-fase4 | sprint:7 | fase:4
-- LEFT JOIN v_sku_alertas para exponer arr de alertas y count.
...
SELECT vsf.sku_origen, p.nombre, p.categoria, p.proveedor_id, pr.nombre_canonico AS proveedor_nombre,
       ...
       -- Sprint 7 Fase 4: alertas autónomas
