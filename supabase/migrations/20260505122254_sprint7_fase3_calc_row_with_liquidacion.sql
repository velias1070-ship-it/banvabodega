-- Sprint 7 Fase 3 — calc_sku_node_policy_row con DIO + dias_extra + liquidacion
-- batch:20260505-sprint-7-fase3 | sprint:7 | fase:3
-- Cambia signatura RETURNS TABLE: agrega 3 columnas (dias_extra, liquidacion_accion,
-- liquidacion_descuento_sugerido). Necesita DROP previo + recreate de la función
-- que la usa: refresh_sku_node_policy_from_templates (CASCADE).
