...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const rows = allRows.map(r => ({
      ...
      comision_unitaria: Number(r.comision_unitaria) || 0,
      comision_total: Number(r.comision_total) || 0,
      costo_envio: Number(r.costo_envio) || 0,
      ingreso_envio: Number(r.ingreso_envio) || 0,
      ingreso_adicional_tc: Number(r.ingreso_adicional_tc) || 0,
      total: Number(r.total) || 0,
      logistic_type: String(r.logistic_type || ""),
