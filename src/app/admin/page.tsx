...
export default function AdminPage() {
  const [tab, setTab] = useState<"dash"|"rec"|"picking"|"etiquetas"|"ops"|"inv"|"mov"|"prod"|"pos"|"stock_load"|"config">("dash");
    ...
    <div className="app-admin">
      ...
      <div className="admin-layout">
        <nav className="admin-sidebar">
          {([["dash","Dashboard","📊"],["rec","Recepciones","📦"],["picking","Picking Flex","🏷️"],["etiquetas","Etiquetas","🖨️"],["ops","Operaciones","⚡"],["inv","Inventario","📦"],["mov","Movimientos","📋"],["prod","Productos","🏷️"],["pos","Posiciones","📍"],["stock_load","Carga Stock","📥"],["config","Configuración","⚙️"]] as const).map(([key,label,icon])=>(
        ...
        <main className="admin-main">
          ...
          <div className="admin-mobile-tabs">
            {([["dash","Dashboard"],["rec","Recepción"],["picking","Picking"],["etiquetas","Etiquetas"],["ops","Ops"],["inv","Inventario"],["mov","Movim."],["prod","Productos"],["pos","Posiciones"],["stock_load","Carga"],["config","Config"]] as const).map(([key,label])=>(
