...
const AdminCatalogoAnalisis = dynamic(() => import("./AdminCatalogoAnalisis"), { ssr: false });
...
export default function AdminCompras() {
  const [tab, setTab] = useState<"ocs" | "proveedores" | "vercatalogo" | "analisiscatalogo" | "catalogo" | "conciliacion">("ocs");
  ...
  return (
    <div style={{ padding: "0 4px" }}>
      ...
      <div style={{ display: "flex", gap: 4, marginBottom: 12, borderBottom: "1px solid var(--bg4)" }}>
        {(["ocs", "proveedores", "vercatalogo", "analisiscatalogo", "catalogo", "conciliacion"] as const).map(t => (
          <button key={t} onClick={() => setTab(t)}
            ...
            {t === "ocs" ? "Órdenes de Compra"
              ...
              : t === "analisiscatalogo" ? "🔍 Análisis Catálogo"
