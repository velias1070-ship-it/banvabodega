...
| [cron-inventory-2026-04-26.md](cron-inventory-2026-04-26.md) | Inventario | Snapshot de los 34 crons activos (22 Vercel + 12 droplet). Categorización 🟢/🟡/🔴 por gating zombi y silent-failure. Punto de partida para futuras auditorías de crons. | Mantener actualizado cuando se agregue/elimine un cron. Re-snapshot cada 6 meses. |
